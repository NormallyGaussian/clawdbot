...
export type ToolsConfig = {
  ...
  web?: {
    search?: {
      ...
      enabled?: boolean;
      /** Search provider ("brave", "gemini", "grok", "kimi", "parallel", or "perplexity"). */
      provider?: "brave" | "gemini" | "grok" | "kimi" | "parallel" | "perplexity";
      ...
      parallel?: {
        ...
        apiKey?: SecretInput;
        /** Base URL override (defaults to "https://api.parallel.ai"). */
        baseUrl?: string;
      };
